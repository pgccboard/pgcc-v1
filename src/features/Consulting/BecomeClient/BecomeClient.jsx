...
function BecomeClient() {
  return (
    <>
      ...
      <div className="mx-auto px-8 flex flex-col lg:flex-row justify-center items-center max-w-screen-2xl">
        <img src={MEETING} alt="MEETING" />
        <div className="text-left lg:pl-16">
          <p className="text-xl font-light">
            At PGCC, we offer Pro Bono consulting services for clients ranging
            from local small businesses, to growing start-ups and international
            firms. We bring together top Penn graduate students of diverse
            backgrounds and expertise to solve business problems spanning
            marketing, strategy, and implementation for firms in education,
            biotech, and beyond.
          </p>
